...
class CW_L2_Attack(Attack):
    ...
    def __init__(self, model,learning_rate):
        ...
        fluid.io.load_vars(executor=self.exe, dirname="../advbox/attacks/mnist/", vars=var_list, main_program=self.attack_main_program)#../advbox/attacks/mnist/
        #########################################
    ...
    def _loss_cw(self,img_0_1,target,shape,c):#,img_input_entrance,softmax_entrance,logits_entrance
        ...
        self.screen_target_logit = self.negetive_screen_nontarget_logit.__add__(fluid.layers.ones(shape=[10],dtype="float32"))
