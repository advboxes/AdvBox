...
def main(use_cuda):
    ...
    #    reader.test(MYTEST_LIST), batch_size=BATCH_SIZE)
    ...
    #定向攻击
    #attack = attack = FGSMT(m)
    #attack_config = {"epsilons": 0.001}
    ...
    if adversary.is_successful():
        ...
        #adversary_image = np.array(adversary_image*255).astype("int").transpose([1,2,0])
        #adversary_image = adversary_image[:, :, ::-1]
        #print(adversary_image)
        #print(adversary_image.shape)

        #print(adversary_image-test_data)
